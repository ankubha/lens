  ...
  const handleFile = useCallback(async (file: File) => {
    ...
    const messages = isUnstructured
      ...
      : [
          ...
          'Detecting PII and semantic types...',
    ...
    <div style={{
      ...
      <div style={{ textAlign: 'center', marginBottom: 56 }} className="animate-fade-up">
        ...
        <p style={{
          ...
          structured intelligence — health scores, extracted facts, summaries, and a
            ...
            <div style={{ display: 'flex', gap: 8, justifyContent: 'center', flexWrap: 'wrap' }}>
              {[
                ...
                <span key={f.label} style={{
                  ...
                  padding: '3px 10px',
                  borderRadius: 4,
                  background: f.type === 'structured' ? '#EFF6FF' :
                              f.type === 'unstructured' ? 'var(--wf-red-light)' : '#FEF9EE',
                  color: f.type === 'structured' ? '#1D4ED8' :
                         f.type === 'unstructured' ? 'var(--wf-red)' : '#B45309',
                  border: `0.5px solid ${
                    f.type === 'structured' ? 'rgba(29,78,216,0.2)' :
                    f.type === 'unstructured' ? 'rgba(215,30,43,0.2)' : 'rgba(180,83,9,0.2)'
                  }`,
                }}>
                  {f.label}
                </span>
      ...
      <div style={{
        ...
        {[
          {
            icon: '📊',
            title: 'Structured Profiling',
            desc: 'Full statistical analysis, PII detection, semantic typing, health scores, and drift detection for CSV and Excel files.',
            color: '#EFF6FF',
          ...
          },
          {
            ...
            desc: 'Extract critical business elements, generate tiered summaries, and build a data dictionary from any PDF document.',
            color: 'var(--wf-red-light)',
            border: 'rgba(215,30,43,0.15)',
          },
          {
            icon: '{}',
            title: 'Semi-structured',
            desc: 'Profile JSON and XML feeds. Schema inference, field coverage, and type detection across batches.',
            color: '#FEF9EE',
